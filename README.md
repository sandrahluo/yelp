...
**Mock Yelp** is a restaurant search app using the [Yelp API](http://www.yelp.com/developers/documentation/v2/search_api).
...
1. How to make the search bar functional
2. Infinite scroll
...
<img src='https://imgur.com/a/HXY9r.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
